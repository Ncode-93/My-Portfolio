...
import nim from "../assets/tinywow_WhatsApp Image 2023-10-07 at 14.27.20_36575896.png";
import { BsDownload } from "react-icons/bs";
import { saveAs } from "file-saver";
import cv from "../assets/Nimish's CV.pdf";
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-xl font-bold pb-2 text-[#00FFCA]">
              Hello Ma'am / Sir, it's a pleasure to meet you
            </p>
            {/* Description */}
            <p className="text-sm leading-7">
              MERN Stack developer and front-end specialist, passionate about
