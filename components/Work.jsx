    ...
    <div name="work" className="w-full bg-gradient-to-l from-[#21073C] to-[#3A1078] py-32">
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center  h-full text-white">
        <div>
          ...
          <p className="text-xl py-6">During my experience as a self-taught developer, I have created many projects and earned a handful experience. I am always on the lookout for new and challenging projects to work on.</p>
        </div>
